...
test("setup server consumes one capability, rejects hostile origins, and never reflects the Coral key", async () => {
  ...
  const running = await startSetupHttpServer({
    ...
    provisionRuntime: async () => ({
      ...
      installed: true,
      verified: true,
      installDir: path.join(home, "runtime/coral/1.4.0"),
      jarPath: path.join(home, "runtime/coral/1.4.0/coral-server-1.4.0.jar"),
      installedVersion: "1.4.0",
      installedTag: "v1.4.0",
      expectedSha256: "1e83a383f35b55367a3f337f39ae66c2a6f09c24a58503fe97281beeb4e1863d",
      actualSha256: "1e83a383f35b55367a3f337f39ae66c2a6f09c24a58503fe97281beeb4e1863d",
      ...
      provisionedAt: "2026-06-24T16:51:20.000Z",
