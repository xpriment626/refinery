...
export declare const refineryCoralModernAgentGlob = "coral/agents-v1.4/*";
export declare const refineryCoralProxyRequestName = "MAIN";
export declare const coralCloudOpenAiProxyProvider = "Coral Cloud, OpenAI";
export declare const deepSeekProxyProvider = "DeepSeek";
...
export declare function refineryCoralModernAgentGlobForRepo(repoRoot?: string): string;
export declare function defaultCoralProxyProvider(modelName: string): string;
