...
import { cwdMatchesFilter, cwdSetMatchesFilter, parseSessionStream, readSessionHeader, scanSessionScope, sessionIndexerSchemaVersion, } from "./codex-session-parser.js";
...
async function main() {
    ...
    try {
        ...
        if (Buffer.byteLength(input) > 16 * 1024 * 1024)
            throw new Error("session index request exceeds 16MB");
...
await main();
//# sourceMappingURL=session-indexer-process.js.map